...
export function initVisualisers() {
    return {
        array: {
            instance: new LinkedListTracer('array', null,
                'Array representation of lists (PROTOTYPE FOR POINTER REPRESENTATION)'),
            order: 0,
        },
        /*
        LList: {
            instance: new LinkedListTracer('linked list', null,
                'linked list (PROTOTYPE FOR POINTER REPRESENTATION)'),
            order: 0,
        },*/
